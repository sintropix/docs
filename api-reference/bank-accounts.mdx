...
<AppLink
  url="https://app.sintropix.com/{entityId}/banks/{bankAccountId}"
  note="That page is the reconciliation view for the account. Account settings are at /{entityId}/settings/bank-accounts."
/>
