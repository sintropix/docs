...
<AppLink
  url="https://app.sintropix.com/{entityId}/home"
  note="Its settings are at /{entityId}/settings/entity and its parent and subsidiaries at /{entityId}/settings/structure."
/>
