...
| Movimiento bancario | `/{entityId}/banks/{bankAccountId}?open={movementId}` | Usa el campo `bankAccountId` del movimiento. La pestaña **Conciliación** del panel es donde el usuario lo concilia. |
