...
description: "Generate P&L, Balance Sheet, General Ledger, and Cash Flow reports in Sintropix — filtered by entity, currency, and date range, ready to export or pin to your dashboard."
---
...
<CardGroup cols={2}>
  <Card title="Profit & Loss (Estado de Resultados)" icon="trending-up">
  ...
  <Card title="Balance Sheet (Balance General)" icon="scale-balanced">
  ...
  <Card title="General Ledger (Libro Mayor)" icon="book-open">
  ...
  <Card title="Cash Flow Statement (Flujo de Caja)" icon="money-bill-wave">
